		...
		<div id="signupbox" style=" margin-top:50px"  class="mainbox col-md-12 col-md-offset-0 col-sm-6 col-sm-offset-6" >
			<div class="panel panel-info" style="background-color: #cab2c7">
				<div class="panel-heading" style="background-color: #9e6f99" >
					<div class="panel-title" style="color:white">Add MostWanted Person</div>
				</div>  
				<div class="panel-body" >
					<form method="post" action="<?php echo SITE_URL_BASE."/MostWanted/addNewMostWanted"?>">
						
						<div id="div_id_date" class="form-group required"> 
							<label for="id_date" class="control-label col-md-4  requiredField"> Date of LastSeen<span class="asteriskField">*</span> </label>
						...
						<div id="div_id_postalCode" class="form-group required">
							<label for="id_postalCode" class="control-label col-md-4  requiredField"> Place of LastSeen<span class="asteriskField">*</span> </label>
							<div class="controls col-md-8 ">
						...
						<div id="div_id_discription" class="form-group required">
							<label for="id_discription" class="control-label col-md-4  requiredField" > Description of MostWanted<span class="asteriskField">*</span> </label>
							<div class="controls col-md-8 ">
