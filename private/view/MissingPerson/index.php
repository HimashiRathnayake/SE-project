		...
		<div id="signupbox" style=" margin-top:50px"  class="mainbox col-md-12 col-md-offset-0 col-sm-6 col-sm-offset-6" >
			<div class="panel panel-info" style="background-color: #cab2c7">
				...
				<div class="panel-body" >
					<form method="post" action="<?php echo SITE_URL_BASE."/MissingPerson/addNewMissingPerson"?>">
						...
						<div id="div_id_discription" class="form-group required">
							<label for="id_discription" class="control-label col-md-4  requiredField" > Description of MissingPeson<span class="asteriskField">*</span> </label>
							<div class="controls col-md-8 ">
