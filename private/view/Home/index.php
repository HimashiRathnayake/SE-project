...
<header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading ">An online comprehensive crime reporting system</div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#about">More Details</a>
      </div>
    </div>
  </header>
  ...
  <!-- About -->
  <section class="page-section" id="about" style="background-color:white;">
    <div class="container">
      <div class="row">
